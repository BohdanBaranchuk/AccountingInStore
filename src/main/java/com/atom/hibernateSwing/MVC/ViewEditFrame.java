 ...
 * Form is showing when we want to edit existing entry in the database
 * <p>
 * We change fields what we want to change and then press the button "Изменить" or we want to discard changes we press
 * the button "Отмена".
 * <p>
...
public class ViewEditFrame {
    ...
    String select_AvailableCriteria[] = {"Да","Нет"};

    JPanel jPanel_infoAboutProduct;             // JPanel for element describes product
    JPanel jPanel_infoAboutSuppler;             // JPanel for element describes supplier
    JPanel jPanel_infoAboutImage;               // JPanel for select Images
    JPanel jPanel_ctrButton;                    // JPanel for Edit and Delete buttons
    JPanel jPanel_main;                         // JPanel for all Jpanels
    ...
    public ViewEditFrame() {
        ...
        show_ImageAdr1 = new JLabel(" - ");
        show_ImageAdr2 = new JLabel(" - ");
        show_ImageAdr3 = new JLabel(" - ");
        show_ImageAdr4 = new JLabel(" - ");
        show_ImageAdr5 = new JLabel(" - ");
        ...
        button_Edit = new JButton("Изменить");
        ...
        select_Color.setEditable(true);
        select_Supplier = new JComboBox();
        select_Supplier.setEditable(true);
        ...
        jPanel_infoAboutProduct.add(info_DateSold);
        jPanel_infoAboutProduct.add(javaFxCalendarSoldDate.getFxPanel());
        jPanel_infoAboutProduct.add(info_InStore);
        jPanel_infoAboutProduct.add(select_Available);
        ...
        jPanel_ctrButton.add(button_Edit);
        ...
        jPanel_main.setPreferredSize(new Dimension(900, 430));


        // Display it all in a scrolling window and make the window appear

        frame = new JFrame("Изменить продукт");
    ...
    public String[] getSelect_AvailableCriteria() {
        return select_AvailableCriteria;
    }

    public void setSelect_AvailableCriteria(String[] select_AvailableCriteria) {
        this.select_AvailableCriteria = select_AvailableCriteria;
    }
